        ...
        extern  __BANK_0_END_head
        extern  __BANK_1_END_head
        extern  __BANK_2_END_head
        extern  __BANK_3_END_head
        extern  __BANK_4_END_head
        extern  __BANK_5_END_head
        extern  __BANK_6_END_head
        extern  __BANK_7_END_head
...
_bankedtapeloader:
        pushall
        ld      ix, __BANK_0_head
        ld      de, __BANK_0_END_head-__BANK_0_head
        ld      c, MEM_BANK_ROM|0x0     ; Bank 0
        call    load_block
        ret     c
        ld      ix, __BANK_1_head
        ld      de, __BANK_1_END_head-__BANK_1_head
        ld      c, MEM_BANK_ROM|0x1     ;Bank 1
        call    load_block
        ret     c
        ld      ix, __BANK_2_head
        ld      de, __BANK_2_END_head-__BANK_2_head
        ld      c, MEM_BANK_ROM|0x2     ;Bank 2
        call    load_block
        ret     c
        ld      ix, __BANK_3_head
        ld      de, __BANK_3_END_head-__BANK_3_head
        ld      c, MEM_BANK_ROM|0x3     ;Bank 3
        call    load_block
        ret     c
        ld      ix, __BANK_4_head
        ld      de, __BANK_4_END_head-__BANK_4_head
        ld      c, MEM_BANK_ROM|0x4     ;Bank 4
        call    load_block
        ret     c
        ld      ix, __BANK_5_head
        ld      de, __BANK_5_END_head-__BANK_5_head
        ld      c, MEM_BANK_ROM|0x5     ;Bank 5
        call    load_block
        ret     c
        ld      ix, __BANK_6_head
        ld      de, __BANK_6_END_head-__BANK_6_head
        ld      c, MEM_BANK_ROM|0x6     ;Bank 6
        call    load_block
        ret     c
        ld      ix, __BANK_7_head
        ld      de, __BANK_7_END_head-__BANK_7_head
